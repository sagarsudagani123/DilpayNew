package com.dilpay.app.postpaid;
...
public class Postpaid_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!CheckNetworkStatus.getConnectivityStatusString(Postpaid_screen.this)) {
            Toast.makeText(Postpaid_screen.this, "No internet connection", Toast.LENGTH_SHORT).show();
            finish();
        }
...
//                    getResponse(number, year + "" + rand_int1, username, password, amount, operator_code, circle_code);
    ...
    private void getResponse(String number, String orderid, String username, String password, String amount, String operator_code, String circle_code) {
        ...
        try {
            dataObj.put("username", new userDetails(Postpaid_screen.this).getNumber());
...
//                          i.putExtra("opid",obj.getInt("opid"));
                            ...
                            Toast.makeText(Postpaid_screen.this, "Enter valid details!", Toast.LENGTH_SHORT).show();
                        }
                    }else{
