...
public class Dth_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!CheckNetworkStatus.getConnectivityStatusString(Dth_screen.this)) {
            Toast.makeText(Dth_screen.this, "No internet connection", Toast.LENGTH_SHORT).show();
            finish();
        }
...
//                getResponse(number, year + "" + rand_int1, username, password, amount, operator_code, circle_code);
                ...
                Intent intent =new Intent(Dth_screen.this, SecurityPin.class);
    ...
    private void getResponse(String number, String orderid, String username, String password, String amount, String operator_code, String circle_code) {
        ...
        try {
            dataObj.put("username", new userDetails(Dth_screen.this).getNumber());
...
//                        Toast.makeText(Dth_screen.this, "==//"+rechargeStatus==null+"", Toast.LENGTH_SHORT).show();
...
//                          i.putExtra("opid",obj.getInt("opid"));
                            ...
                            Toast.makeText(Dth_screen.this, "Enter valid details!", Toast.LENGTH_SHORT).show();
                        }
                    }else{
            ...
            public void onFailure(Call<String> call, Throwable t) {
                ...
                Toast.makeText(Dth_screen.this, message + ""+t.toString(), Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
