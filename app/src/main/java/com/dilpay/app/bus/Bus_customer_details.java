...
import com.dilpay.app.Validations;
...
public class Bus_customer_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        proceed.setOnClickListener(view -> {
            ...
            if (boardingPoint.equalsIgnoreCase("") || dropingPoint.equalsIgnoreCase("") ||
                    email.equalsIgnoreCase("") || number.equalsIgnoreCase("")) {
                Toast.makeText(Bus_customer_details.this, "Fill in all details", Toast.LENGTH_SHORT).show();
            } else {
                if (new Validations().numberValidate(number)) {
                    startActivity(intent);
                } else {
                    Toast.makeText(Bus_customer_details.this, "Invalid Number", Toast.LENGTH_SHORT).show();
                }
            }
        });
