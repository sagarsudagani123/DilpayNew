    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upi_card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Bus_payment_options.this, UPI_payments_screen.class);
                i.putExtra("upi", "UPI Payments");
                ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(Bus_payment_options.this, findViewById(R.id.upi), "trans1");
        ...
        net_card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(Bus_payment_options.this, findViewById(R.id.net_banking), "trans2");
                startActivity(i, compat.toBundle());
            }
        });
        ...
        credit_card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(Bus_payment_options.this, findViewById(R.id.credit), "trans3");
                startActivity(i, compat.toBundle());
            }
        });
        debit_card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityOptionsCompat compat = ActivityOptionsCompat.makeSceneTransitionAnimation(Bus_payment_options.this, findViewById(R.id.debit), "trans4");
                startActivity(i, compat.toBundle());
            }
        });
